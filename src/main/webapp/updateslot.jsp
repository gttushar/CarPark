  ...
  color: white;
    ...
    <body>
        ...
        <%
            ...
            out.println("Garage : <b>"+garage+"</b>");
        %>
        <br><br>
        <form action="updateslot">
            Enter Slotno. : &emsp;<input type ="text" style="width:100px" name ="slotno"> <br>
            Enter New Price : <input type ="text" style="width:100px" name ="price"> <br><br>
