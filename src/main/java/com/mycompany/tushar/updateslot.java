...
//@author Tushar
@WebServlet(name="updateslot", urlPatterns={"/updateslot"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try{
            ...
            if(rs == null){
                ...
                stmt.execute("UPDATE Slots SET Price = "+price+" WHERE (Garage = '"+garage+"' AND Slotno ="+slotno+")");
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Price changed!');");
                out.println("location='garageupdate.jsp';");
                out.println("</script>");
            }         
        } 
